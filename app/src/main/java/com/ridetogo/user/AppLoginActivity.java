...
import com.ViewPagerCards.CardAdapter;
...
public class AppLoginActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener{
    ...
    MTextView languageText, currancyText, loginbtn, registerbtn; //introductondetailstext
    ...
    public void setColorLangCode(String textColor, String bgColor) {
        ...
        //rahul
       // languagearea.getBackground().setTint(Color.parseColor("#FFFFFF"));
    }
    ...
    public void setColorCurrCode(String textColor, String bgColor) {
        ...
        currancyText.setTextColor(Color.parseColor("#000000"));
        //r
      //  currencyarea.getBackground().setTint(Color.parseColor("#FFFFFF"));
    }
...
//                       bannerHeight);
    ...
    public void onPageSelected(int position) {
      if(position == 0){
          layoutBackground.setBackground(getResources().getDrawable(R.mipmap.onboarding_scr_bg1));
        //  layoutBackground.setBackgroundColor(getResources().getColor(R.color.gray));
      }if(position == 1){
            layoutBackground.setBackground(getResources().getDrawable(R.mipmap.onboarding_scr_bg2));
          //  loginbtn.setBackground(getResources().getDrawable(R.drawable.login_btn_background));
        }if(position == 2){
            layoutBackground.setBackground(getResources().getDrawable(R.mipmap.onboarding_scr_bg3));
          //  layoutBackground.setBackgroundColor(getResources().getColor(R.color.gray));
        }if(position == 3){
            layoutBackground.setBackground(getResources().getDrawable(R.mipmap.onboarding_scr_bg4));

          //  layoutBackground.setBackgroundColor(getResources().getColor(R.color.black));
        }
    }
