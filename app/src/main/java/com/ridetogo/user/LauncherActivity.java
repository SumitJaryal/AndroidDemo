...
public class LauncherActivity extends BaseActivity implements ProviderInstaller.ProviderInstallListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        splash_animated = (VideoView) findViewById(R.id.splash_animated);
        String path = "android.resource://" + getPackageName() + "/" + R.raw.video;
        splash_animated.setVideoURI(Uri.parse(path));
        splash_animated.setZOrderOnTop(true);
        splash_animated.start();
