...
import com.ridetogo.user.BookingActivity;
import com.ridetogo.user.BusinessProfileActivity;
import com.ridetogo.user.CardPaymentActivity;
import com.ridetogo.user.ContactUsActivity;
import com.ridetogo.user.EmergencyContactActivity;
import com.ridetogo.user.FavouriteDriverActivity;
import com.ridetogo.user.HelpActivity;
import com.ridetogo.user.InviteFriendsActivity;
import com.ridetogo.user.MenuSettingActivity;
import com.ridetogo.user.MyProfileActivity;
import com.ridetogo.user.MyWalletActivity;
import com.ridetogo.user.NotificationActivity;
import com.ridetogo.user.R;
import com.ridetogo.user.SearchPickupLocationActivity;
import com.ridetogo.user.StaticPageActivity;
import com.ridetogo.user.VerifyInfoActivity;
import com.ridetogo.user.deliverAll.EditCartActivity;
import com.ridetogo.user.deliverAll.LoginActivity;
